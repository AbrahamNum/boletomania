...
class Evento extends ActiveRecord {
    ...
    protected static $columnasDB = ['id', 'nombre', 'descripcion', 'disponibles', 'categoria_id', 'dia_id', 'hora_id', 'cantante_id'];
    ...
    public function __construct($args = [])
    {
        ...
        $this->cantante_id = $args['cantante_id'] ?? '';
    }
    ...
    public function validar() {
        ...
        if(!$this->cantante_id || !filter_var($this->cantante_id, FILTER_VALIDATE_INT) ) {
