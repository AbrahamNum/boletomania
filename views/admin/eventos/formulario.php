...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="cantantes" class="formulario__label">Cantante</label>
        <input
            type="text"
        ...
        >
        <ul id="listado-cantantes" class="listado-cantantes"></ul>

        <input type="hidden" name="cantante_id" value="<?php echo $evento->cantante_id; ?>">
    </div>
