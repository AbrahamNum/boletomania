<main class="agenda">
    <h2 class="agenda__heading">Conciertos & Festivales</h2>
    <p class="agenda__descripcion">Los mejores eventos de Boletomania</p>

    <div class="eventos">
        <h3 class="eventos__heading">Conciertos</h3>
    ...
    <div class="eventos eventos--festivales">
        <h3 class="eventos__heading">Festivales</h3>
        <p class="eventos__fecha">Viernes 5 de Octubre</p>
